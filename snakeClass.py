...
def initialize_game(player, game, food):
    """
    Initialize the game by creating a start action and do that move
    :param player:  player class
    :param game:    game class
    :param food:    food class
    :return:        None
...
def run():
    ...
    while counter_games < number_episodes:
        ...
        counter_games += 1                              # Increase the number of played games with one

        # Print the number of games and the achieved score of that game
        print('Game', counter_games, '      Score:', game.score)

        # Append score and game number to plot the vectors score_plot & counter_plot
